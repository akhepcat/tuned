...
NAMESPACE = "com.ubuntu.tuned"
DBUS_BUS = NAMESPACE
DBUS_INTERFACE = "com.ubuntu.tuned.control"
DBUS_OBJECT = "/Tuned"
...
BOOT_DIR = "/boot"
GRUB2_CFG_FILES = ["/boot/grub2/grub.cfg", "/boot/grub/grub.cfg", "/boot/efi/EFI/redhat/grub.cfg", "/boot/efi/EFI/fedora/grub.cfg", "/boot/efi/EFI/centos/grub.cfg"]
